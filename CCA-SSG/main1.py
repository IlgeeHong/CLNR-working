...
parser.add_argument('--drop_rate_edge', type=float, default=0.1)
parser.add_argument('--drop_rate_feat', type=float, default=0.4)
parser.add_argument('--result_file', type=str, default="/results/CCASSG_node_classification")
parser.add_argument('--embeddings', type=str, default="/results/CCASSG_node_classification_embeddings")
