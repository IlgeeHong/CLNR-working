...
parser.add_argument('--result_file', type=str, default="/Ours/results/SemiGCon_hyperparamter")
...
def train_semi(model, data, num_per_class, pos_idx, fmr, edr):
    model.train()
    optimizer.zero_grad()
    new_data1 = random_aug(data, fmr, edr)
    new_data2 = random_aug(data, fmr, edr)
                        ...
                        for epochs in [20, 50]:
                            ...
                            for exp in range(args.n_experiments): 
                                ...
                                for epoch in range(epochs):
                                    loss = train_semi(model, data, num_per_class, pos_idx, fmr, edr) ###
