...
parser.add_argument('--result_file', type=str, default="/results/SelfGCon_node_classification1")
parser.add_argument('--embeddings', type=str, default="/results/SelfGCon_node_classification_embeddings1")
