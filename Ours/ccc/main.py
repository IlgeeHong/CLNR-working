...
parser.add_argument('--result_file', type=str, default="/Ours/ccc/results/metric1")
...
for args.model in ['dCCA-SSG']:#,'CLNR','GRACE','CCA-SSG','GRACE_CCA','dCCA-SSG']:
...
res.to_csv(file_path + "_" + args.model + "_" + str(args.batch) + "_" + str(args.out_dim) + "_" + str(args.hid_dim) + "_" + args.dataset +  ".csv", index=False) #str(args.epochs)args.model + "_" + 
