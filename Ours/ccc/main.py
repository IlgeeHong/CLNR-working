...
parser.add_argument('--fmr', type=float, default=0.1) #0.1 #0.2
parser.add_argument('--edr', type=float, default=0.4) #0.4 #0.5
...
# newly added
results =[]
for args.model in ['CLNR','CLNR2','bCLNR','bCLNR2','dCLNR','dCLNR2','GRACE','CCA-SSG']:
