...
parser.add_argument('--dataset', type=str, default='CS') #ogbn-arxiv
...
parser.add_argument('--fmr', type=float, default=0.3) #0.1 #0.2
parser.add_argument('--edr', type=float, default=0.1) #0.4 #0.5
