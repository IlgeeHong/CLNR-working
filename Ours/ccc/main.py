...
parser.add_argument('--result_file', type=str, default="/Ours/ccc/results/OGBN") #Final_test1
...
results =[]
for args.model in ['nCLNR','CLNR','dCLNR','GRACE']: 
    if args.model in ['nCLNR','bCLNR','dCLNR','CLNR']:
        args.epochs = 5000
        args.lr1 = 1e-2
        args.wd1 = 0.0
