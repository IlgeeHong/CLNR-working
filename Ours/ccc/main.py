...
parser.add_argument('--fmr', type=float, default=0.3) #0.0 #0.2 # 0.0 # photo 0.2 0.3 ?
...
parser.add_argument('--result_file', type=str, default="/Ours/ccc/results/PUBMED") #Final_test1
