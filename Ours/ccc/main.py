...
parser.add_argument('--edr', type=float, default=0.4) #0.6 #0.5 # ogbn
...
parser.add_argument('--result_file', type=str, default="/Ours/ccc/results/Final_test") #_test_epoch_lamb
