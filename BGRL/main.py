...
parser.add_argument('--fmr1', type=float, default=0.3)
parser.add_argument('--fmr2', type=float, default=0.4)
parser.add_argument('--edr1', type=float, default=0.3)
parser.add_argument('--edr2', type=float, default=0.2)
