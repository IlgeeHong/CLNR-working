...
parser.add_argument('--proj', type=str, default="nonlinear")
...
for exp in range(args.n_experiments):      
    ...
    results += [[args.model, args.dataset, args.mlp_use, args.proj, args.epochs, args.n_layers, args.lr1, args.lr2, args.wd1, args.wd2, args.channels, args.tau, args.edr, args.fmr, eval_acc.item()]]
    res1 = pd.DataFrame(results, columns=['model', 'dataset', 'mlp_use', 'proj', 'epochs', 'layers', 'lr1', 'lr2', 'wd1', 'wd2', 'channels', 'tau', 'edr', 'fmr', 'accuracy'])
